...
def main():
    ...
    while True:
        ...
        print("2. Standardisation (Camarade 2)")
        print("5. Déterminisation (Camarade 3)")
        print("6. Minimisation (Camarade 4)")
        print("7. Reconnaissance de mots (Candidat 5)")
        print("8. Créer l'automate complémentaire (Candidat 5)")
